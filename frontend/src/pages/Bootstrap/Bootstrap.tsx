        ...
        try {
            ...
            setError(
                axios.isAxiosError(requestError)
                    ? requestError.response?.data?.detail || "Unable to create organization. Please try again."
    ...
    return (
        <main className={styles.page}>
            <form className={styles.card} onSubmit={submit}>
                ...
                <p className={styles.help}>Set up a new organization and your first admin account.</p>

                <label>
                    Organization name
                    <input value={organizationName} onChange={(event) => setOrganizationName(event.target.value)} autoComplete="organization" required />
                </label>
                ...
                <button type="button" className={styles.linkButton} onClick={() => navigate("/login")}>Back to login</button>
            </form>
        </main>
    );
};
